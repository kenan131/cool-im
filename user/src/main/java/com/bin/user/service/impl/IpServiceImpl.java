...
import com.bin.user.domain.dto.IpResult;
import com.bin.user.domain.entity.IpDetail;
import com.bin.user.domain.entity.IpInfo;
import com.bin.user.domain.entity.User;
import com.bin.user.exception.GlobalUncaughtExceptionHandler;
import com.bin.user.service.IpService;
